[![Build](https://github.com/L-K-M/FunKey-OS-Favorites/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/L-K-M/FunKey-OS-Favorites/actions/workflows/build.yml?query=branch%3Amaster)
...
```bash
curl -O https://raw.githubusercontent.com/L-K-M/FunKey-OS-Favorites/master/docker/Dockerfile
...
git clone https://github.com/L-K-M/FunKey-OS-Favorites.git
cd FunKey-OS
make sdk all
```
