...
image: fun
	...
	@rm -rf root tmp
	@mv images/sdcard.img images/FunKey-sdcard-Favorites.img
...
image-prod: fun
	...
	@rm -rf root tmp
	@mv images/sdcard-prod.img images/FunKey-sdcard-prod-Favorites.img
...
update: fun
	...
	tr " " "\n" | \
	cpio -o -H crc --quiet > ../images/FunKey-rootfs-Favorites.fwu
	@rm -rf tmp
