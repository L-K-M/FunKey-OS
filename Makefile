...
image: fun
	...
	@rm -rf root tmp
	@mv images/sdcard.img images/FunKey-sdcard-Favorites_RG_Nano.img
...
image-prod: fun
	...
	@rm -rf root tmp
	@mv images/sdcard-prod.img images/FunKey-sdcard-prod-Favorites_RG_Nano.img
...
update: fun
	...
	tr " " "\n" | \
	cpio -o -H crc --quiet > ../images/FunKey-rootfs-Favorites_RG_Nano.fwu
	@rm -rf tmp
